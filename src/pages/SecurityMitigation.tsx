      ...
      <div className="grid grid-cols-2 gap-6 relative z-10">
          ...
          <div className="overflow-x-auto">
            <table className="ews-table w-full">
              ...
              <tbody className="divide-y divide-gray-800/20">
                {(riskMatrix as RiskMatrixItem[]).map((item: RiskMatrixItem, idx: number) => (
                  <tr 
                    key={idx} 
        ...
        <div className="ews-card p-6 relative overflow-hidden group/card">
          ...
          <div className="space-y-4 relative z-10">
            {(crowdMonitoring as CrowdMonitoringItem[]).map((item: CrowdMonitoringItem, idx: number) => (
              <div 
                key={idx}
      ...
      <div className="grid grid-cols-3 gap-6 relative z-10">
        ...
        <div className="ews-card p-6 relative overflow-hidden group/card">
          ...
          <div className="space-y-3 relative z-10">
            {(vitalObjects as VitalObjectItem[]).map((obj: VitalObjectItem, idx: number) => (
              <div 
                key={idx}
        ...
        <div className="ews-card p-6 relative overflow-hidden group/card">
          ...
          <div className="space-y-5 relative z-10">
            {(utilities as UtilityItem[]).map((util: UtilityItem, idx: number) => (
        ...
        <div className="ews-card p-6 relative overflow-hidden group/card">
          ...
          <div className="space-y-3 relative z-10">
            {(recommendations as RecommendationItem[]).map((rec: RecommendationItem, idx: number) => (
              <div 
                key={idx}
