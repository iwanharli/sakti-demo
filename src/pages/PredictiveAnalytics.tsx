...
interface PredictiveSource {
  name: string;
  description: string;
}

interface RecidivismPerson {
  id: number;
  name: string;
  initials: string;
  riskLevel: string;
      ...
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="ews-card relative overflow-hidden group/card shadow-2xl">
          ...
          <div className="p-3 space-y-2 max-h-[600px] overflow-auto ews-scrollbar">
            {(recidivismData as RecidivismPerson[]).map((person: RecidivismPerson) => (
              <div 
                key={person.id}
        ...
        <div className="col-span-2 space-y-5">
          <div className="ews-card relative overflow-hidden p-6 group/card shadow-2xl">
            ...
            <div className="p-5">
              <div className="grid grid-cols-2 gap-8 mb-6">
                {[
                  { title: 'CURANMOR (VEKTOR TEMPORAL)', data: curanmorPredictions as PredictionItem[], accent: 'red' },
                  { title: 'BEGAL (VEKTOR TEMPORAL)', data: begalPredictions as PredictionItem[], accent: 'cyan' }
                ].map((section, sidx) => (
                  <div key={sidx} className="space-y-4">
                    ...
                    <div className="space-y-5">
                      {section.data.map((loc: PredictionItem, lidx: number) => (
                        <div key={lidx} className="group/loc">
                          ...
                          <div className="relative h-6 flex items-end gap-1">
                            {loc.timeVector.map((val: number, vidx: number) => (
              ...
              <div className="bg-[#0d1425]/40 border border-cyan-500/20 rounded-lg p-4 relative overflow-hidden group/env">
                 ...
                 <div className="grid grid-cols-2 gap-6 relative z-10">
                   ...
                   <div className="space-y-3">
                     ...
                     {environmentFactors.activeEvents.map((ev: EnvironmentEvent, i: number) => (
          ...
          <div className="ews-card relative overflow-hidden group/card shadow-2xl">
            ...
            <div className="p-4 grid grid-cols-2 gap-3">
              {(dataSources as PredictiveSource[]).map((source: PredictiveSource, idx: number) => (
                <div 
                  key={idx}
